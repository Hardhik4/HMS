...
export default function DoctorReports() {
  ...
  // Static reports - replace with API call when backend is ready
  const reports = [
    {
      id: 1,
      ...
      treatment: ["Tablet Paracetamol: for pain/fever", "Antibiotic (Amoxicillin): 5 days", "Warm salt water gargles: 2 times daily", "Steam inhalation: once daily"],
    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        ...
        {selected === null ? (
          ...
          // Single Report Detail View (same style as patient's medical report page)
          <div className="dashboard-section-card">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px", paddingBottom: "14px", borderBottom: "1px solid #e5e7eb" }}>
              <div>
                <p style={{ fontWeight: "700", fontSize: "17px", margin: 0, color: "#111827" }}>{selected.patientName}</p>
            ...
            <button
              ...
              style={{ marginTop: "24px", padding: "9px 22px", background: "#1e3a8a", color: "#fff", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "14px", fontWeight: "600" }}
            >
              ← Back to Reports
            </button>
          </div>
